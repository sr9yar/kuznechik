 ...
 *
 */
export const LINEAR = new Uint8Array([
...
export const MODES: { [key: string]: string } = {
  ECB: 'ECB', // Режим простой замены electronic codebook ECB
  CTR: 'CTR', // Режим гаммирования counter CTR
  OFB: 'OFB', // Режим гаммирования с обратной связью по выходу Output feedback OFB
  CBC: 'CBC', // Режим простой замены с зацеплением Cipher Block Chaining CBC
  CFB: 'CFB', // Режим гаммирования с обратной связью по шифрттексту Cipher Feedback CFB
  MAC: 'MAC', // Режим выработки иммитовставки Message authentication code algorithm MAC
};
